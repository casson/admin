...
class CheckCode
{
	...
	function __construct($font_file) {
	
		$this->font = TOP_PATH.'public'.DIRECTORY_SEPARATOR.'fonts'.DIRECTORY_SEPARATOR.$font_file;
	}
	...
	private function creat_font() {
		...
		for ($i=0; $i<$this->code_len; $i++) {
			imagettftext($this->img, $this->font_size, rand(-30,30), $x*$i, $this->height/1.3, $this->font_color, $this->font, $this->code[$i]);
