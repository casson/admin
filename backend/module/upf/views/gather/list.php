...
<link rel="stylesheet" type="text/css" href="<?php echo $this->module->assetsUrl; ?>/js/uploadify/uploadify.css"/>
<link rel="stylesheet" type="text/css" href="<?php echo $this->module->assetsUrl; ?>/js/uploadify/custom.css"/>
<script type="text/javascript" src="<?php echo $this->module->assetsUrl; ?>/js/uploadify/jquery.uploadify.min.js?r=<?php echo rand(0,9999)?>"></script>
<script type="text/javascript" src="<?php echo $this->module->assetsUrl; ?>/js/uploadify/<?php echo Yii::app()->language; ?>.js?r=<?php echo rand(0,9999)?>"></script>
...
$(function() {
	$('#file_upload').uploadify({
		...
		'buttonImage' : '<?php echo $this->module->assetsUrl; ?>/images/swfBnt.png',
		'swf'      : '<?php echo $this->module->assetsUrl; ?>/js/uploadify/uploadify.swf',
...
?>
  <tr  id="<?php echo $key;?>"> 
    ...
    <td width="10%" class="hback"> <div align="left"> 图像 </div></td>
    <td width="10%" class="hback"><div align="left"> <?php   echo $r["size"];?></div></td>
