       	...
       	<div class="common_form" style="width:500px;">
			 ...
			 <table cellpadding="0" cellpadding="0">
				<tbody>
					...
					<td><?php echo Html::activeTextInput($model,'controller',  array('class'=>'text')) ?></td>
					</tr>
					
					<tr>
					<td><?php echo Html::activeLabel($model,'action');?></td>
					<td><?php echo Html::activeTextInput($model,'action',  array('class'=>'text')) ?></td>
					</tr>
					
					<tr>
					<td><?php echo Html::activeLabel($model,'btn_class');?></td>
					<td><?php echo Html::activeDropDownList($model,'btn_class',$model->getBtnClassOptions(),array('empty'=>Yii::t('admin','please select'))); ?></td>
					</tr>
					
					<tr>
					<td><?php echo Html::activeLabel($model,'title_field');?></td>
					<td><?php echo Html::activeTextInput($model,'title_field',  array('class'=>'text')) ?></td>
					</tr>
					
					<tr>
					<td><?php echo Html::activeLabel($model,'list_order');?></td>
					<td><?php echo Html::activeTextInput($model,'list_order',  array('class'=>'text')) ?></td>
					</tr>
